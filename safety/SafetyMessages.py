SAFETY_MESSAGES = {
    "en": {
        ...
        "asr_failure": "Sorry, I did not hear you clearly. Please repeat your message slowly.",
        "asr_failure_final": "I am still having trouble hearing you. Please stay on the line. I am connecting you to an operator now.",
    ...
    "fr": {
        ...
        "asr_failure": "Désolé, je ne vous ai pas bien entendu. Veuillez répéter lentement votre message.",
        "asr_failure_final": "J'ai encore du mal à vous entendre. Veuillez rester en ligne. Je vous connecte à un opérateur maintenant.",
    ...
    "sw": {
        ...
        "asr_failure": "Samahani, sikukusikia vizuri. Tafadhali rudia ujumbe wako polepole.",
        "asr_failure_final": "Bado nina shida kukusikia. Tafadhali baki kwenye simu. Ninakuunganisha na mhudumu sasa.",
